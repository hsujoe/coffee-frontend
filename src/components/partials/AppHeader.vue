        ...
        <b-nav-item-dropdown right class="preview-list user-dropdown">
          <template slot="button-content">
            <div class="d-flex align-items-center">
              ...
              <img class="img-md rounded-circle" v-bind:src="'data:image/jpeg;base64,'+user.image" alt="Profile image">
            </div>
          </template>
          <b-dropdown-item>
          ...
          <b-dropdown-item-button v-on:click="signOut">Sign Out<i class="dropdown-item-icon ti-power-off"></i></b-dropdown-item-button>
        </b-nav-item-dropdown>
      </b-navbar-nav>
...
export default {
  ...
  methods: {
    ...
    signOut: function () {
      ...
      // this.saveState = Cookies.getJSON('user')
