      ...
      <div class="card">
        <div class="card-body">
            ...
            <dir class="row">
              ...
              <div class="col-4">
                <b-button id = "search" variant="outline-success" class="mb-2" v-on:click="getRunShops">
          ...
          <b-table id="runShopList" responsive
                  :items="dataList"
                  :fields="fields"
                  :per-page="perPage"
            ...
            <template v-slot:cell(id)="data">
              <a :href="`#${'/runShopVE/'+data.value}`" >{{ data.value }}</a>
            </template>
...
export default {
  ...
  computed: {
    runShops () {
      return this.$store.state.runShops
    }
  },
  watch: {
    runShops (val) {
  ...
  mounted () {
    var parameter = {}
    this.$store.dispatch('getRunShops', parameter)
  },
  methods: {
    toAdd: function () {
      location.href = '#/runShopAdd'
    },
    getRunShops: function () {
      var parameter = {}
